...
#  SAVE THE MODEL HERE into a binary file WITH PICKLE
#  so now we can just import this thing from a binary file and do predict whenever we wan
...
#  OTHER WAY TO DO IT WITH JOBLIB
